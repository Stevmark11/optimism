...
// Reset rolls back the state of the supervisor for the given chain.
func (su *SupervisorBackend) Reset(chain eth.ChainID, blockNum uint64) error {
	return su.chainDBs.Rewind(chain, blockNum)
}
